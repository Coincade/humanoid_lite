...
import humanoid_lite.tasks.locomotion.velocity.mdp as mdp
from humanoid_lite.tasks.locomotion.velocity.velocity_env_cfg import LocomotionVelocityEnvCfg
from humanoid_lite_assets.robots.humanoid_lite import HUMANOID_LITE_CFG, HUMANOID_LITE_JOINTS
...
@configclass
class HumanoidLiteEnvCfg(LocomotionVelocityEnvCfg):
